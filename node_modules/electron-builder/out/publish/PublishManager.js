...
let writeUpdateInfo = (() => {
    var _ref3 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (event, _publishConfigs) {
        ...
        let sha2 = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy(function () {
            return hash(event.file, "sha256");
        });
        let sha512 = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy(function () {
            return hash(event.file, "sha512");
        });
